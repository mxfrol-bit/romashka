...
> **v2 FINAL (17.07.2026)**  
> Исправлена ошибка Streamlit (`default value not in options`).  
> Все 15 чекеров (truepeople, beenverified, intelius, truthfinder и др.) зарегистрированы.  
> **ДЕМО-режим включён** — без API-ключей сразу возвращаются правдоподобные USA данные (ФИО + адрес + штат) для тестирования пайплайна и веб-интерфейса.
